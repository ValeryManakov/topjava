...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL))
                ...
                .andExpect(MealTestData.MEALTO_MATCHER.contentJson(MealsUtil.getTos(meals, MealsUtil.DEFAULT_CALORIES_PER_DAY)));
    }
    ...
    void getBetween() throws Exception {
        ...
        perform(MockMvcRequestBuilders.get(REST_URL + "/filter"+ parameters))
                ...
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MealTestData.MEALTO_MATCHER.contentJson(MealsUtil.getTos(Arrays.asList(meal3, meal2, meal1), MealsUtil.DEFAULT_CALORIES_PER_DAY)));
    }
}